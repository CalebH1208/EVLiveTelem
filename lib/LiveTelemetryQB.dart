...
List<Data> displayValues = [
  ...
  // Data("PDM LC 1", 8, 5, 1, 1, "A", 1),
  // Data("PDM LC 2", 8, 6, 1, 1, "A", 1),
  // Data("PDM LC 3", 8, 7, 1, 1, "A", 1),
  // Data("PDM LC 4", 8, 8, 1, 1, "A", 1),
  // Data("PDM HC 1", 8, 9, 1, 1, "A", 1),
  // Data("PDM HC 2", 8, 10, 1, 1, "A", 1),
  // Data("PDM HC 3", 8, 11, 1, 1, "A", 1),
  // Data("PDM HC 4", 8, 12, 1, 1, "A", 1),
  // Data("Damper Pot FL", 8, 13, 1, 1, "MM", 1),
  // Data("Damper Pot FR", 8, 14, 1, 1, "MM", 1),
  // Data("Damper Pot RL", 8, 15, 1, 1, "MM", 1),
  // Data("Damper Pot RR", 8, 16, 1, 1, "MM", 1),
  ...
  // Data("Inv Gate Driver PCB temp", 8, 27, 1, 1, "°C", 1),
  // Data("A Inverter Gate Driver temp", 8, 28, 1, 1, "°C", 1),
  // Data("B Inverter Gate Driver temp", 8, 29, 1, 1, "°C", 1),
  // Data("C Inverter Gate Driver temp", 8, 30, 1, 1, "°C", 1),
  // Data("Inverter Hot Spot Temp", 8, 31, 1, 1, "°C", 1),
  // Data("Inverter DC-Link Current", 8, 32, 1, 1, "A", 1),
  // Data("Coolant FLow", 8, 33, 1, 1, "IDK?", 1),
  // Data.nu("APPS Plausibility flag", 8, 34, 1, 1, 1),
  // Data("Inv Est Coolant Temp", 8, 35, 1, 1, "°C", 1),
  // Data.nu("Inverter post Fault Code", 8, 36, 1, 1, 1),
  // Data.nu("Inverter Run Code", 8, 37, 1, 1, 1),
  // Data("TS Power", 8, 38, 1, 1, "WATTS", 1),
];
